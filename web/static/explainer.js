  ...
  const STEPS = [
...

    {
      ...
      note: `<b>기존 후보를 고치는 게 아니라 새 버전을 만든다.</b> v1은 "왜 실패했는지" 그대로 남아 있는
             ...
             넘어가는 단계는 하나도 없다.<br><br>
             ③번 진단 프롬프트는 FutureHouse Robin의 공개 프롬프트("정확히 N개의 구별되는
             아이디어" + "필요 없으면 만들지 않는다")를 실제로 읽고 고친 것이다 — 가설 문장
             하나를 지표 수만큼 복제하던 이전 동작을, 가설마다 서로 다른 원인과 그 가설만
             가르는 시험을 갖도록 바꿨다. 자세한 대조는 README 9장에 있다.`,
    },
